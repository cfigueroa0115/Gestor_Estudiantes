                    ...
                    {COLUMNS.map((col) => (
                      ...
                      >
                        {col.key === 'accion' ? (
                          ...
                          semaforo === 'vencida' ? (
                            <span className="inline-flex items-center gap-1 rounded-full bg-red-100 px-2.5 py-0.5 text-xs font-bold text-red-800 animate-[glow-red_1.5s_ease-in-out_infinite]">
                            ...
                            <span className="inline-flex items-center gap-1 rounded-full bg-yellow-100 px-2.5 py-0.5 text-xs font-bold text-yellow-800 animate-[glow-yellow_2s_ease-in-out_infinite]">
